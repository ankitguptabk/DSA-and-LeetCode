<h2><a href="https://leetcode.com/problems/number-of-good-ways-to-split-a-string/?envType=problem-list-v2&envId=string">1525. Number of Good Ways to Split a String</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code>.</p>
