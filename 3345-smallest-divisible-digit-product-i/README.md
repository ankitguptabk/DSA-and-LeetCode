<h2><a href="https://leetcode.com/problems/smallest-divisible-digit-product-i/?envType=problem-list-v2&envId=math&difficulty=EASY">3345. Smallest Divisible Digit Product I</a></h2><h3>Easy</h3><hr><p>You are given two integers <code>n</code> and <code>t</code>. Return the <strong>smallest</strong> number greater than or equal to <code>n</code> such that the <strong>product of its digits</strong> is divisible by <code>t</code>.</p>
