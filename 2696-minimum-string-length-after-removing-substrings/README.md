<h2><a href="https://leetcode.com/problems/minimum-string-length-after-removing-substrings/?envType=problem-list-v2&envId=string">2696. Minimum String Length After Removing Substrings</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> consisting only of <strong>uppercase</strong> English letters.</p>
