<h2><a href="https://leetcode.com/problems/generate-a-string-with-characters-that-have-odd-counts/?envType=problem-list-v2&envId=string">1374. Generate a String With Characters That Have Odd Counts</a></h2><h3>Easy</h3><hr><p>Given an&nbsp;integer <code>n</code>, <em>return a string with <code>n</code>&nbsp;characters such that each character in such string occurs <strong>an odd number of times</strong></em>.</p>
