<h2><a href="https://leetcode.com/problems/evaluate-the-bracket-pairs-of-a-string/?envType=problem-list-v2&envId=string">1807. Evaluate the Bracket Pairs of a String</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code> that contains some bracket pairs, with each pair containing a <strong>non-empty</strong> key.</p>
