<h2><a href="https://leetcode.com/problems/reformat-date/?envType=problem-list-v2&envId=string">1507. Reformat Date</a></h2><h3>Easy</h3><hr><p>Given a <code>date</code> string in the form&nbsp;<code>Day Month Year</code>, where:</p>
